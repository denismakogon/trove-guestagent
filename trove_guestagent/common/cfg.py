...
common_opts = [
    cfg.StrOpt('sql_connection',
               default='sqlite:///trove_guestagent_test.sqlite',
               help='SQL Connection',
               secret=True),
    ...
    cfg.StrOpt('backup_runner',
               default='trove_guestagent.guestagent.'
                       'backup.backup_types.InnoBackupEx'),
    ...
    cfg.StrOpt('backup_namespace',
               default='trove_guestagent.guestagent.strategies.'
                       'backup.mysql_impl',
               help='Namespace to load backup strategies from.'),
    cfg.StrOpt('restore_namespace',
               default='trove_guestagent.guestagent.strategies.restore.'
                       'mysql_impl',
    ...
    cfg.StrOpt('storage_namespace',
               default='trove_guestagent.guestagent.strategies.storage.swift',
    ...
    cfg.StrOpt('remote_swift_client',
               default='trove_guestagent.common.remote.swift_client'),
