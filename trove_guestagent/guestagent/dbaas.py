...
from trove_guestagent.openstack.common import log
...
defaults = {
    'mysql': 'trove_guestagent.guestagent.datastore.mysql.manager.Manager',
    'percona': 'trove_guestagent.guestagent.datastore.mysql.manager.Manager',
    'redis': 'trove_guestagent.guestagent.datastore.redis.manager.Manager',
    'cassandra': 'trove_guestagent.guestagent.datastore.'
