...
from trove_guestagent.openstack.common import eventlet_backdoor
...
from trove_guestagent.openstack.common import threadgroup


rpc = importutils.try_import('trove_guestagent.openstack.common.rpc')
CONF = cfg.CONF
