...
from trove_guestagent.common.exception import ProcessExecutionError
from trove_guestagent.common import utils
from trove_guestagent.common import instance as rd_instance
from trove_guestagent.conductor import api as conductor_api
import trove_guestagent.guestagent.datastore.mysql.service as dbaas
from trove_guestagent.guestagent import dbaas as dbaas_sr
from trove_guestagent.guestagent import pkg
from trove_guestagent.guestagent.dbaas import to_gb
from trove_guestagent.guestagent.dbaas import get_filesystem_volume_stats
# from trove_guestagent.guestagent.datastore.service import BaseDbStatus
from trove_guestagent.guestagent.datastore.redis import service as rservice
from trove_guestagent.guestagent.datastore.redis.service import RedisApp
from trove_guestagent.guestagent.datastore.redis import system as RedisSystem
# from trove_guestagent.guestagent.datastore.cassandra import service as cass_service  # noqa
from trove_guestagent.guestagent.datastore.mysql.service import MySqlAdmin
from trove_guestagent.guestagent.datastore.mysql.service import MySqlRootAccess
from trove_guestagent.guestagent.datastore.mysql.service import MySqlApp
from trove_guestagent.guestagent.datastore.mysql.service import MySqlAppStatus
from trove_guestagent.guestagent.datastore.mysql.service import KeepAliveConnection  # noqa
from trove_guestagent.guestagent.db import models
# from trove_guestagent.instance.models import InstanceServiceStatus
...
#         self.orig_utils_execute_with_timeout = dbaas.utils.execute_with_timeout  # noqa
...
#         dbaas.utils.execute_with_timeout = self.orig_utils_execute_with_timeout  # noqa
...
class ServiceRegistryTest(testtools.TestCase):
    ...
    def test_datastore_registry_with_extra_manager(self):
        datastore_registry_ext_test = {
            'test': 'trove_guestagent.guestagent.datastore.test.manager.Manager',
        }
        ...
        self.assertEqual(test_dict.get('mysql'),
                         'trove_guestagent.guestagent.datastore.mysql.'
                         'manager.Manager')
        self.assertEqual(test_dict.get('percona'),
                         'trove_guestagent.guestagent.datastore.mysql.'
                         'manager.Manager')
        self.assertEqual(test_dict.get('redis'),
                         'trove_guestagent.guestagent.datastore.redis.'
                         'manager.Manager')
        self.assertEqual(test_dict.get('cassandra'),
                         'trove_guestagent.guestagent.datastore.cassandra.'
                         'manager.Manager')

    def test_datastore_registry_with_existing_manager(self):
        datastore_registry_ext_test = {
            'mysql': 'trove_guestagent.guestagent.datastore.mysql.'
                     'manager.Manager123',
        }
        dbaas_sr.get_custom_managers = Mock(return_value=
                                            datastore_registry_ext_test)
        ...
        self.assertEqual(test_dict.get('percona'),
                         ...
                         'manager.Manager')
        self.assertEqual(test_dict.get('redis'),
                         'trove_guestagent.guestagent.datastore.redis.manager.Manager')
        self.assertEqual(test_dict.get('cassandra'),
                         'trove_guestagent.guestagent.datastore.cassandra.'
                         'manager.Manager')
