...
from trove_guestagent.tests.config import CONFIG as test_config
...
from trove_guestagent.tests.util import test_config as CONFIG
from trove_guestagent.tests.util.client import TestClient as TestClient
from trove_guestagent.tests.util.users import Requirements
from trove_guestagent.common.utils import import_object
from trove_guestagent.common.utils import import_class
...
class MySqlConnection(object):
    ...
    def assert_fails(self, ip, user_name, password):
        from trove_guestagent.tests.util import mysql
        try:
